...
export const cidade_lista_all = async () => {
    try {
        const resp = await Api.get(`/cidade/listall`);
...
export const cidade_delete = async (id) => {
    try {
...
export const cidade_add = async (obj) => {
...
export const cidade_find_by_id = async (id) => {
    try {
...
export const cidade_update = async (obj) => {
